package com.egrand.cloud.core.security;

import com.egrand.cloud.core.utils.BeanConvertUtils;
import com.egrand.cloud.core.utils.ReflectionUtils;
...
//    }
    ...
    public static OAuth2AccessToken createAccessToken(AuthorizationServerEndpointsConfiguration endpoints, Map<String, String> postParameters) throws Exception {
        ...
        if (!clientSecret.equalsIgnoreCase(clientDetails.getClientSecret())) {
